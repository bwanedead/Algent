# Reviewer Task — Iteration 7

Run ID: 2026-01-29__cockpit-3
Iteration: iter-0007
...
1. **Worker Summary**: `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3\phases\worker\iter-0007\output/worker_summary.md`
2. **PRD Progress**: `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3/prd.json` (check `passes` fields)
3. **Progress Log**: `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3/progress.md`
...
**All complete?** NO - recommend CONTINUE
...
You MUST write your decision to:
  `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3\phases\reviewer\iter-0007\output/review_result.json`

...
Iteration: iter-0001 (internal: 0)
...
**Output Requirement**: After completing your work, write a summary to:
  `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3\phases\worker\iter-0001\output/worker_summary.md`
...
**S1**: Add Cockpit entry point and view switch
- Size: XS
- Acceptance Criteria:

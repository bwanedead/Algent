# Worker Task — Iteration 5

Run ID: 2026-01-29__cockpit-3
Iteration: iter-0005 (internal: 4)
...
**Output Requirement**: After completing your work, write a summary to:
  `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3\phases\worker\iter-0005\output/worker_summary.md`
...
- Size: S
- Acceptance Criteria:
  - Run state panel displays fields from mock run.json (status, phase, iteration, timestamps)
  - Docs panel renders PRD/progress text and story list from mock prd.json

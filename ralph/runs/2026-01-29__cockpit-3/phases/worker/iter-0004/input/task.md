# Worker Task — Iteration 4

Run ID: 2026-01-29__cockpit-3
Iteration: iter-0004 (internal: 3)
...
**Output Requirement**: After completing your work, write a summary to:
  `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3\phases\worker\iter-0004\output/worker_summary.md`
...
**S4**: Repo selection and run list UI
- Size: S
- Acceptance Criteria:

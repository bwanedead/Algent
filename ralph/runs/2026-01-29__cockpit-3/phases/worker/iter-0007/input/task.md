# Worker Task — Iteration 7

Run ID: 2026-01-29__cockpit-3
Iteration: iter-0007 (internal: 6)
...
**Output Requirement**: After completing your work, write a summary to:
  `C:\projects\Algent\ralph\runs\2026-01-29__cockpit-3\phases\worker\iter-0007\output/worker_summary.md`
...
- Size: S
- Acceptance Criteria:
  - Events panel shows the most recent lines from mock events.ndjson
  - User can refresh or auto-follow to see new lines

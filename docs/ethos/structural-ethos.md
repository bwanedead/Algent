...
- **Scaffolding and skeleton** (core services, pipelines, hooks):
...
## 3. Reliability and Dependability as First-Class Qualities
...
- Slightly more mechanical wiring (for example, explicit handshakes, explicit purge steps, central helpers) when it prevents surprising behavior.
...
- Users will lean on the system in ways we did not originally design for.
